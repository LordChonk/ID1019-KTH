defmodule Bench do
    ...
    def bench(n) do
      ...
      :io.format("# benchmark of map as list and tree (loop: ~w) \n", [n])
      ...
      Enum.each(ls, fn (i) -> {i, tla, tta, tma, tll, ttl, tml, tlr, ttr, tmr} = bench(i, n)
  ...
  def bench(i, n) do
    ...
    {tla, tll, tlr}  = bench(seq, n, &EnvL.new/0, &EnvL.add/3, &EnvL.lookup/2, &EnvL.remove/2)
    {tta, ttl, ttr}  = bench(seq, n, &EnvT.new/0, &EnvT.add/3, &EnvT.lookup/2, &EnvT.remove/2)
